...
function ProjectDetail() {
  ...
  if (!project) {
    return (
      <div className="py-20 text-center space-y-4">
        ...
        <p className="text-zinc-400">Proyek yang Anda cari tidak tersedia atau URL salah.</p>
        <Link
          to="/portfolio"
          className="inline-block px-5 py-2 rounded-lg bg-zinc-900 border border-zinc-800 text-sm text-zinc-300 hover:text-white hover:border-zinc-700 transition"
        >
  ...
  return (
    <article className="max-w-4xl mx-auto py-8 space-y-10">
      ...
      <section className="flex flex-wrap items-center gap-4 pt-4 border-t border-zinc-800/80">
        {project.githubUrl && (
          <a
